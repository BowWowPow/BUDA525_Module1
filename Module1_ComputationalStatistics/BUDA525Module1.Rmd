...
```{r, echo=FALSE}
library(vembedr)
embed_youtube("https://youtu.be/tm4188bx2BU")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/FJuvD9d3LGU")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/H91iY4uhf_Y")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/Lqiu0GJ2xGM")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/5EsQyQYRr9Y")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/RVD_wh09pq4")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/isF0ldFQhtI")
```
...
```{r echo=FALSE}
embed_youtube("https://youtu.be/S8U99vq_lFc")
```
...
### Correlation Example
```{r echo=FALSE}
embed_youtube("https://youtu.be/uTZ-JzZv6sE")
```
