...
privateCount <- 0
pubCount <- 0
# we know our dataset is 777 in size,
for(j in 1:777)
{
  #print(isPrivateOrPublic[j])
...
for(j in 1:777)
{
  ...
  if(isPrivateOrPublic[j] == "No")
  {
    isPrivateOrPublic[j] = 0
  }
  else if(isPrivateOrPublic[j] == "Yes")
  {
    isPrivateOrPublic[j] = 1
  }
}


privateCount + pubCount

privateCount / 777 * 100
