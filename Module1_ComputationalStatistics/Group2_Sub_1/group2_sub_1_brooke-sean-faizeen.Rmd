...
minus our stats gives us what is the "remainder" which tells us which is more than the other in terms of college applications from private vs public schools. ~~~ what is our observation ~~~ 
```{r}
...
At 0 for our sum, we cannot reject the null hypothesis in this case as it does look like there is a statistical relationship between Appplications and Private/Public data. 