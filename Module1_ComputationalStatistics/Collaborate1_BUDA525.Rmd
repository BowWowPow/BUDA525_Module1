...
samp_d<-NULL
for(j in 1:10000){
  # Create a new data frame and mix up the job class over and over. # JC = jobclass
  # dataset we're breaking up the relationship between wage/jobclass.
...
# the null. -- ??? 
# how many times did I see when my_stat was less than samp_d/n samples
